...
namespace AmpRageRepo.Models
{
    public class LicensePlateSearcher
    {
        ...
        private static Car FindMatchingCar(RootObject rootObject)
        {
            ...
            string filepath = @"https://raw.githubusercontent.com/Kappawez/AmpRageRepo/master/AmpRageRepo/wwwroot/data/elcars3.txt";
        ...
        private static Car CheckForPlateInFile(string inputRegNumber)
        {
            ...
            var counter = 0;
            var listOfProps = new List<string>();
            string filepath = @"https://raw.githubusercontent.com/Kappawez/AmpRageRepo/master/AmpRageRepo/wwwroot/data/elcars4.txt";
            foreach (var item in File.ReadAllLines(filepath))
            {
